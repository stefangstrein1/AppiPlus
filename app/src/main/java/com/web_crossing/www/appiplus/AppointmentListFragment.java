...
/**
 * A list fragment representing a list of Appointments. This fragment
 * also supports tablet devices by allowing list items to be given an
 * 'activated' state upon selection. This helps indicate which item is
 * currently being viewed in a {@link AppointmentDetailFragment}.
 * <p/>
...
public class AppointmentListFragment extends ListFragment {
    ...
    //private ArrayAdapter<MemberAppointments> mAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       /* setListAdapter(new ArrayAdapter<Appointments>(
                getActivity(),
                android.R.layout.simple_list_item_activated_1,
                android.R.id.text1,
                AppointmentContent.Appointments));*/
    }
